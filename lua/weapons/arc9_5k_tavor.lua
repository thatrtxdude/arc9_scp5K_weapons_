...
SWEP.CustomSelectIcon = Material("vgui/hud/5k_tavor")
...
SWEP.ViewModel = "models/weapons/5K/tavor/c_tavor.mdl"
...
SWEP.VisualRecoilCenter = Vector(20, 25, -0)
SWEP.VisualRecoilUp = 20
SWEP.VisualRecoilSide = 3.5 -- Horizontal tilt
SWEP.VisualRecoilSideAddSighted = -1 -- Horizontal tilt
SWEP.VisualRecoilRoll = 110 -- Roll tilt
...
SWEP.MovingPos = Vector(-0, -2.5, 0.75)
SWEP.MovingAng = Angle(-0, 1, -3)

SWEP.SprintAng = Angle(40, 10, -45)
SWEP.SprintPos = Vector(3, -3, 0)

SWEP.CrouchPos = Vector(-0, -2.5, 0.75)
...
SWEP.ShootSound = { path .. "tavor/fire_tavor/Tavor_shot_core_1.wav", path .. "tavor/fire_tavor/Tavor_shot_core_2.wav", path .. "tavor/fire_tavor/Tavor_shot_core_3.wav", path .. "tavor/fire_tavor/Tavor_shot_core_4.wav", path .. "tavor/fire_tavor/Tavor_shot_core_5.wav" }
SWEP.LayerSound = { path .. "tavor/fire_tavor/Tavor_shot_tail_outdoor_1.wav", path .. "tavor/fire_tavor/Tavor_shot_tail_outdoor_2.wav", path .. "tavor/fire_tavor/Tavor_shot_tail_outdoor_3.wav", path .. "tavor/fire_tavor/Tavor_shot_tail_outdoor_4.wav", path .. "tavor/fire_tavor/Tavor_shot_tail_outdoor_5.wav" }

SWEP.ShootSoundSilenced = { path .. "tavor/fire_tavor/Tavor_shot_sil_1.wav", path .. "tavor/fire_tavor/Tavor_shot_sil_2.wav", path .. "tavor/fire_tavor/Tavor_shot_sil_3.wav", path .. "tavor/fire_tavor/Tavor_shot_sil_4.wav", path .. "tavor/fire_tavor/Tavor_shot_sil_5.wav" }
SWEP.LayerSoundSilenced = { path .. "SMG_Sil_Tail_Outdoor_1.wav", path .. "SMG_Sil_Tail_Outdoor_2.wav", path .. "SMG_Sil_Tail_Outdoor_3.wav" }

SWEP.ShootSoundSilencedIndoor = { path .. "tavor/fire_tavor/Tavor_shot_sil_1.wav", path .. "tavor/fire_tavor/Tavor_shot_sil_2.wav", path .. "tavor/fire_tavor/Tavor_shot_sil_3.wav", path .. "tavor/fire_tavor/Tavor_shot_sil_4.wav", path .. "tavor/fire_tavor/Tavor_shot_sil_5.wav" }
...
SWEP.ShootSoundIndoor = { path .. "tavor/fire_tavor/Tavor_shot_core_1.wav", path .. "tavor/fire_tavor/Tavor_shot_core_2.wav", path .. "tavor/fire_tavor/Tavor_shot_core_3.wav", path .. "tavor/fire_tavor/Tavor_shot_core_4.wav", path .. "tavor/fire_tavor/Tavor_shot_core_5.wav" }
...
SWEP.DropMagazineModel = "models/weapons/5K/tavor/w_tavor_mag.mdl"
SWEP.DropMagazineSounds = {"physics/metal/weapon_impact_soft1.wav", "physics/metal/weapon_impact_soft2.wav", "physics/metal/weapon_impact_soft3.wav"}
SWEP.DropMagazineAmount = 1
SWEP.DropMagazineSize = 0.2
SWEP.DropMagazineTime = 1.25
SWEP.DropMagazinePos = Vector(-55, -5, 0)
...
SWEP.Attachments = {
    {
        PrintName = "Skins",
        --Bone = "v_weapon.Clip",
        Category = "scp5k_skins_tavor",
		CosmeticOnly = true,
    },
	{
        PrintName = "Sights",
        Category = {"scp5k_tavor_sights", "csgo_optic"},
        Bone = "Barrel",
        Pos = Vector(-2, 13, -0),
        Ang = Angle(180, -90, 90),
        Installed = "scp5k_att_tavor_sights",
        Integral = "scp5k_att_tavor_sights",
    },
	{
        PrintName = "Muzzle",
        Category = { "muzzle", "scp5k_tavor_muzzle" },
        Bone = "Barrel",
        Pos = Vector(-0, -0, -0),
        Ang = Angle(0, 90, -90),
		Installed = "scp5k_att_tavor_muzzle",
        Integral = "scp5k_att_tavor_muzzle",
    },
    {
        PrintName = "Magazine",
        Category = {"scp5k_tavor_mag"},
        Bone = "Safety",
        Pos = Vector(-0.65, 4.75, 0.5),
        Ang = Angle(0, -90, -0),
		Installed = "scp5k_att_tavor_mag",
        Integral = "scp5k_att_tavor_mag",
    },
    {
        PrintName = "Grip",
        Category = {"grip","grip_aug"},
        Bone = "root",
        Pos = Vector(0, -6.6, -2.34),
        Ang = Angle(180, -90, -0), 
    },
    {
        PrintName = "Ammo",
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
		    { s = "5ktavormagpouchdown", t = 0 / 10 },
			{ s = "5ktavormagout", t = 5 / 10 },
			{ s = "5ktavormagin", t = 11 / 10 },
			{ s = "5ktavormagpouchup", t = 17 / 10 },
			{ s = "5ktavorhandlingbarrel", t = 21 / 10 },
        },
    },
    ["reload_empty"] = {
        Source = "reload_empty",
        ...
        EventTable = {			
			{ s = "5ktavormagoutempty", t = 4 / 10 },
			{ s = "5ktavormagpouchemptydown", t = 7.5 / 10 },
			{ s = "5ktavormaginempty", t = 13 / 10 },
			{ s = "5ktavorboltempty", t = 19 / 10 },
			{ s = "5ktavorhandlingbarrelempty", t = 24 / 10 },
			{ s = "5ktavormagpouchemptyup", t = 27 / 10 },
        },
    },
    ["ready"] = {
        Source = "inspect",
    ...
    ["inspect"] = {
        ...
        EventTable = {
		    { s = "5ktavormagcheckout", t = 0 / 10 },
			{ s = "5ktavormagcheckin", t = 18 / 10 },
			{ s = "5ktavorhandlingbarrel", t = 24 / 10 },
        },
    },
    ["inspect_empty"] = {
        Source = "inspect",
        ...
        EventTable = {
		    { s = "5ktavorinspectrotate", t = 0 / 10 },
			{ s = "5ktavorinspectboltback", t = 21 / 10 },
			{ s = "5ktavorinspectboltforward", t = 30 / 10 },
			{ s = "5ktavorhandlingbarrelempty", t = 36 / 10 },
        },
    },
}
